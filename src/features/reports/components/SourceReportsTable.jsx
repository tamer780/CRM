...
const SourceReportsTable = ({
	...
	const columns = useMemo(
		() => [
			...
			{
				accessorKey: "leads",
				header: t("reports.sources.columns.leads"),
				cell: ({ getValue }) => (
			...
			},
			{
				...
				header: t("reports.sources.columns.qualified"),
				cell: ({ getValue }) => (
					<span className="text-sm text-text">{formatInteger(getValue())}</span>
				),
			},
			{
				...
				header: t("reports.sources.columns.converted"),
				cell: ({ getValue }) => (
					<span className="text-sm text-text">{formatInteger(getValue())}</span>
				),
			},
...
export default SourceReportsTable;
