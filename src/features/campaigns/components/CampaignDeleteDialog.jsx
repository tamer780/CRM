			...
			>
				<div className="px-5 py-5">
					...
					<h2 id={titleId} className="text-lg font-semibold text-text">
						{t("campaigns.delete.title")}
					</h2>
					<p className="mt-1.5 text-sm text-muted">
						{t("campaigns.delete.message")}
					</p>
					<p className="mt-2 text-sm font-medium text-text">{campaign.name}</p>
					<p className="mt-1 text-xs text-muted">
						{t("campaigns.delete.cannotUndo")}
					</p>
					{error && (
						<p
							role="alert"
