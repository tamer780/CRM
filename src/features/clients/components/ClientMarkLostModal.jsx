...
const ClientMarkLostModal = ({
	...
	const handleConfirm = () => {
		...
		if (!trimmed) {
			setFieldError(t("clients.validation.lostReasonRequired"));
			return;
		}
		setFieldError("");
		onConfirm(trimmed);
				...
				<div className="px-5 py-5">
					...
					<label className="mt-4 block">
						...
						<textarea
							...
							placeholder={t("clients.markLost.reasonPlaceholder")}
						/>
						{(fieldError || error) && (
...
export default ClientMarkLostModal;
