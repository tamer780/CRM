...
import { hasActiveCampaignFilters } from "../utils/campaignFilters";
...
const CampaignsToolbar = ({
	...
	const hasActive = hasActiveCampaignFilters({
		...filters,
		...
		<div className="sticky top-0 z-20 rounded-2xl border border-border bg-surface/95 px-3 py-3 shadow-sm backdrop-blur-sm sm:px-4">
			<div className="flex flex-wrap items-end gap-2 sm:gap-3">
				<label className="relative min-w-[12rem] flex-1 basis-full sm:basis-64">
					<span className="sr-only">{t("campaigns.searchPlaceholder")}</span>
					<Search
				...
				<FilterDropdown
					...
					allLabel={t("campaigns.filters.allPlatforms")}
					placeholder={t("campaigns.filters.platform")}
				/>
